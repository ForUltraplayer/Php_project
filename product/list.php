...
$total_sql = "SELECT COUNT(*) FROM project.product";
...
if ($mode == "search") {
    if (!$search) {
        ...
        $sql = "SELECT * FROM project.product WHERE $find LIKE '%$search%' ORDER BY num DESC LIMIT $page_start, $list";
        $count_sql = "SELECT COUNT(*) FROM project.product WHERE $find LIKE '%$search%'";
        $count_result = $pdo->query($count_sql);
        $count = $count_result->fetchColumn();
    }
} else {
    $sql = "SELECT * FROM project.product ORDER BY num DESC LIMIT $page_start, $list";
}
...
<div id="wrap">
    ...
    <div id="content">
        ...
        <!-- end of col1 -->
        <div id="col2">
            <div id="title"><img src="../img/title_product.png"></div>
